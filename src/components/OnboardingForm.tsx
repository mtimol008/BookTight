...
export function OnboardingForm({ profile }: { profile: ProfileRecord }) {
  ...
  return (
    <form action={formAction} onSubmit={handleSubmit}>
      ...
      <div className="field">
        <label className="field-label" htmlFor="onboarding-distance-unit">
          Distance units
        </label>
        <select
      ...
      <div className="field">
        <label className="field-label" htmlFor="onboarding-max-travel">
          Max travel range ({distanceUnit})
        </label>
        <input
          id="onboarding-max-travel"
          className="input"
          type="number"
      ...
      <div className="field">
        <label className="field-label" htmlFor="onboarding-max-jobs">
          Max jobs per day
        </label>
        <input
          id="onboarding-max-jobs"
          className="input"
          type="number"
          name="maxJobsPerDay"
          min={1}
